...
for domain in ['ted', 'wipo']:
    for size in ['half', 'quarter', 'tiny']:
        ...
        print(row('adapted_gd_student_baseline_teacher', domain, size, f'{domain} & {size} & Student & Baseline'))
...
end_table('Continue Training ID Models on Gold Data. Notes: Whether this helps seems to depend on the dataset. Interested to see trends for other languages, but punting for now.', 'id-continue')
